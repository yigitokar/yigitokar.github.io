...
The derivations of these statements can be easily seen by writing down little toy examples of each case, hence I omit them here. ( Just a little hint on the derivation of $x^TBx$; use the second statement: $ (Bx)_{k} = $  to make it easier.) 
